...
<table width="100%" border="0" cellpadding="0">
	<tr>
		<td><a class="listPagesLabel">Mostrando <?= $pages_properties->getFirstResult() ?>
			al <?= $pages_properties->getLastResult() ?></a>
			<a class="listCurrentPage">de <?= $pages_properties->getTotalResults() ?>
			registro<?= $pages_properties->getTotalResults() != 1 ? 's' : '' ?></a></td>
		<td align="right">
			<span class="listPagesLabel">Páginas:</span>
			<?
