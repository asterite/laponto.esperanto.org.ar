...
if ($title || $instructions || $help_page) {
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				if ($title) {
					...
					<td valign="top" align="left" class="abmTitle"><!--
						--><img src="<?= $context_path ?>/interfaco/images/mini_icon_2.gif">
						<?= $title ?></td>
					<?
				}
				if ($help_page) {
					...
					<td valign="middle" align="right"><!--
						...
						--><img src="<?= $context_path ?>/interfaco/images/help_icon.gif" border="0"></a></td>
					<?
				}
				?>
			</tr>
		...
		?>
		<tr>
			<td colspan="2" valign="top" height="1" class="abmInstructionsSeparators"><img src="<?= $context_path ?>/interfaco/images/blank.gif" width="5" height="1"></td>
		</tr>
		<?
		if ($instructions) {
			?>
