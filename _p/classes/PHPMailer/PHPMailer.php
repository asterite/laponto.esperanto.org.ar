...
class PHPMailer
{
    ...
    */
    ...
    function SmtpSend($header, $body) {
    		// Cambiado para compatibilizar con el framework
    		PHP::requireClasses('PHPMailer/SMTP');
     ...
     * @return bool
     */
    function SetLanguage($lang_type, $lang_path = '_p/classes/PHPMailer/languages/') {
        if(file_exists(PHP::realPath($lang_path.'phpmailer.lang-'.$lang_type.'.php')))
            include(PHP::realPath($lang_path.'phpmailer.lang-'.$lang_type.'.php'));
        else if(PHP::realPath(file_exists($lang_path.'phpmailer.lang-en.php')))
            include(PHP::realPath($lang_path.'phpmailer.lang-en.php'));
        else
        {
